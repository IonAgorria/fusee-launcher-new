...
class HaxBackend(ABC):
    ...
    STANDARD_REQUEST_DEVICE_TO_HOST_TO_DEVICE = STANDARD_REQUEST_DEVICE_TO_HOST | 0x0
    STANDARD_REQUEST_DEVICE_TO_HOST_TO_INTERFACE = STANDARD_REQUEST_DEVICE_TO_HOST | 0x1
    STANDARD_REQUEST_DEVICE_TO_HOST_TO_ENDPOINT = STANDARD_REQUEST_DEVICE_TO_HOST | 0x2
    GET_STATUS        = 0x0
    GET_DESCRIPTOR    = 0x6
